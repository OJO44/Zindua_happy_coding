...
for name in names:
    ...
    # For removing any extra whitespace or characters
...
# iterate through the lists (formatted lists) at once, consider using zip.
for name,brand,  price, discount, review in zip(formatted_names, formatted_brands, formatted_prices,formatted_discounts,formatted_Reviews, ):
    print(f"Items: {name}, Brand: {brand}, Price: {price}, Discount : {discount}, Review: {review}, "'\n')
